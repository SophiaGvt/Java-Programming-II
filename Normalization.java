...
/**
 * Class with methods to normalize user input text and text taken from HTML
 * files, it also removes stop words from the latter.
 * 
 * @author Nikos
 */
public class Normalization {
	...
	public static String[] inputNormalization() {
		String inputText = HashtoArray.getInputTerm();
	 ...
	 * @param htmlText
	 *            : text from HTML
	 * @return String[] wordList (contains duplicate values, does not contain
	 *         stopwords)
	 */
